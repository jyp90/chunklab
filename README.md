...
![Demo: upload a document, drag-select the answer to make a question, run the matrix, read the recommendation and copy the LangChain snippet](docs/images/demo.gif)
